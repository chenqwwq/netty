...
abstract class PoolArena<T> extends SizeClasses implements PoolArenaMetric {
    ...
    /**
     * 这里和{@see <link href="https://www.jianshu.com/p/86fbacdb68bd"/>}中描述的不一样，Arena不再细分为tiny
     * <p>
     * 具体哪个版本改的不知道
     */
    enum SizeClass {
    ...
    /**
     * @param parent         创建该Arena的Allocator
     * @param pageSize       页面大小
     * @param pageShifts     doubt:
     * @param chunkSize      Arena的下一级单位，Chunk的大小
     * @param cacheAlignment 缓存的填充
     */
